...
TEXTS = {
    ...
    "en": {
        "lang": "Language", "menu_title": "Menu", "menu_home": "🏠 Home", "menu_items": "📦 Items",
        "menu_stock": "📝 Stock", "menu_forecast": "📊 Forecast", "menu_toothbrush": "🪥 Toothbrush",
        "menu_calendar": "📅 Calendar", "dashboard_alert": "Alerts", "dashboard_incoming": "Incoming",
        "dashboard_total_items": "Items", "btn_delete": "Delete", "success_delete": "Deleted.",
        "warn_no_data": "No Data.", "weekdays": ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
        "prev_month": "Prev", "next_month": "Next", "today": "Today", "cal_search_item": "Search Item",
        "cal_list": "List", "cal_tab_new": "New", "cal_tab_list": "List/Del", "cal_header": "Calendar",
        "tb_header": "Toothbrush Sim", "forecast_header": "Forecast", "stock_header": "Stock Input",
        "items_header": "Item Master", "btn_save_stock": "Save", "btn_save_cal": "Save",
        "btn_register": "Register", "btn_update": "Update", "success_save_stock": "Saved",
        "success_save_cal": "Saved", "success_register": "Registered", "success_update": "Updated",
        "err_db": "DB Error: ", "err_col": "Missing col: "
    },
    "ko": {
...
def main():
    ...
    with st.sidebar:
        ...
        # Find the original key for the selected label
        try:
